...
public class ForumUserTestSuite {
    ...
    void testGeFriendsLocation() {
        ...
        //      user7:  "Washington"
        //      user10: "Miami"
        assertEquals(3, user1.getFriendsLocation().size());
        assertTrue(user1.getFriendsLocation().contains("Key West"));
        assertTrue(user1.getFriendsLocation().contains("Washington"));
        assertTrue(user1.getFriendsLocation().contains("Miami"));
        assertFalse(user1.getFriendsLocation().contains("Orlando"));
    }
    ...
    void testGetLocationsOfFriendsOfFriends() {
        ...
        assertEquals(3, user1.getFriendsOfFriendsLocation().size());
        assertTrue(user1.getFriendsOfFriendsLocation().contains("Key West"));
        assertTrue(user1.getFriendsOfFriendsLocation().contains("Washington"));
        assertTrue(user1.getFriendsOfFriendsLocation().contains("Miami"));
        assertFalse(user1.getFriendsOfFriendsLocation().contains("Orlando"));
    }
}
